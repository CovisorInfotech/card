                                    ...
                                    <div class="card-body card-block">
                                        <form action="update-form-query.php?update_id=<?php echo $row['id'] ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <input type="time" id="text-input" value="<?php echo $row['time_taken_work'] ?>" name="time_taken_work" placeholder="" class="form-control" required>
                                                </div>
                                                
                                                <div class="col-12 col-md-6 p-2">
                                                <label for="text-input" class=" form-control-label">Select Tags</label>
                                                <select id="select" name="tags" class="form-control" required="" fdprocessedid="femy7c">
                                                        <option value="<?php echo $row[''] ?>"><?php echo $row['tags'] ?></option>
                                                        <option value="Tags1">Tags1</option>
                                                        <option value="Tags2">Tags2</option>
                                                        <option value="Tags3">Tags3</option>
                                                </select>
                                                </div>
