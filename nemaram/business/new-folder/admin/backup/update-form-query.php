...
$tags = $_POST['tags'];
    ...
    $sql = "UPDATE blog SET name_client='$name_client', link_client_profile='$link_client_profile', blog_title='$blog_title', work_short_discription='$work_short_discription', ratings_client='$ratings_client, blog_image='$blog_image', blog_description='$blog_description', pincode='$pincode', city='$city', state='$state', country='$country', amount_work='$amount_work', time_taken_work='$time_taken_work', tags='$tags', blog_dat='$blog_date' WHERE id=$update_id";
     move_uploaded_file($tempname, $folder);
    
    if (mysqli_query($db, $sql)) {
      echo "<script>alert('About Update'); window.location = 'blog.php';</script>";
    } else {
    }
 }
