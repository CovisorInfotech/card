                                        ...
                                        while ($row = mysqli_fetch_assoc($res)) {
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <a href="?id=<?php echo $row['id'] ?>&type=approve"><span class="bg-success text-white p-1">Approve</span></a>
                                                    <?php
                                                    } else {
                                                    ?>
                                                    <a href="?id=<?php echo $row['id'] ?>&type=pending"><span class="bg-danger text-white p-1">Pending</span></a>
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
