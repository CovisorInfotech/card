<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //   $forget = "Select * from useradmin where password='$password'";
      
      $sql = "SELECT id FROM useradmin WHERE  password = '$old_password'";
    ...
    //   $active = $row['active'];
      ...
      if($count == 1) {
        ...
        mysqli_query($db,"update useradmin set 	username='$myusername' , password='$new_password' where password='$old_password'");
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" value="Submit">Change Password</button>
