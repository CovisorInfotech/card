                    ...
                    <ul class="navbar-mobile__list list-unstyled">
						...
						<li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <!--<li>-->
                                <!--    <a href="product-attributes.php">Product Attributes</a>-->
                                <!--</li>-->
                                <!--<li>-->
                                <!--    <a href="product-policy.php">Product Policy</a>-->
                                <!--</li>-->
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                            <i class="fas fa-desktop"></i>FAQ</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                            <i class="fas fa-desktop"></i>About</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                            <i class="fas fa-desktop"></i>Profile</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <div class="header-button">
                                <div class="noti-wrap">
                                    <div class=""><a href="../index.php" class="btn btn-primary">Home</a></div>
