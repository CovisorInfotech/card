...
<?php
        ...
        $sql =  "SELECT * FROM `product_attributes` WHERE adminuser_id='$adminuser_id'";
        $res = mysqli_query($db, $sql);

        $sql_cat =  "SELECT * FROM `product_attributes_title` WHERE adminuser_id='$adminuser_id'";
        ...
        if (isset($_GET['type']) && $_GET['type'] !== '' && isset($_GET['id']) && $_GET['id'] > 0) {
            ...
            $id = $_GET['id'];
            if ($type == 'delete') {
                mysqli_query($db, "delete from product_attributes where id='$id' and adminuser_id='$adminuser_id'");
                                    ...
                                    <div class="table-data__tool-left">
                                        ...
                                        <div class="rs-select2--light">
                                           <ul class="nav nav-pills d-flex">
                                                ...
                                                <a href="add-product-attributes.php" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>Add item</a>
                                                </li>    
                                                <li class="nav-item p-1">
                                                 <a class="nav-link active" data-bs-toggle="pill" href="#attributes">Product Attributes</a>
                                                </li>
                                                <li class="nav-item p-1">
                                       ...
                                       <?php
                                        while ($row = mysqli_fetch_assoc($res)) {
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <span class="block-email"><b><?php echo $row['attributes_title'] ?></b></span>
                                                </td>
                                                <td class="desc"><?php echo $row['attributes_name'] ?></td>
                                                <!-- <td>
