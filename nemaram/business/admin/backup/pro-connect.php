                            ...
                            <form action="update-form-query.php?update_id=<?php echo $coned['id'] ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <label for="text-input" class=" form-control-label">Download File</label>
                                        ...
                                        <div id="preview1"><img src="images/download/<?php echo $coned['download_file'] ?>" width="150px" height="150px" alt="" /></div>
                                        <input type="file" id="text-input" value="<?php echo $coned['download_file'] ?>" name="download_file" placeholder="" class="form-control" onchange="getImagePreview1(event)">
                                        <input type="hidden" id="text-input" value="<?php echo $coned['download_file'] ?>" name="download_file_old" placeholder="" class="form-control">
                                    </div>
