                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left d-flex">
                                        ...
                                        <div class="rs-select2--light d-flex pb-2">
                                            <ul class="nav nav-pills d-flex">
                                                <li class="nav-item">
                                                 <a class="nav-link active" data-bs-toggle="pill" href="#home">List</a>
                                                </li>
                                                <li class="nav-item">
                                                 <a class="nav-link" data-bs-toggle="pill" href="#menu1">Add</a>
                                                </li>
                                            </ul>
                                        </div>
