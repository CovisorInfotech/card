...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $thames_color = $_POST['thames_color'];
   ...
   $sql = "UPDATE useradmin SET image='$image', designation='$designation', company='$company', business_category='$business_category', logo='$logo', thumbnail_image='$thumbnail_image', thames_color='$thames_color' WHERE id=$adminuser_id";
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <select id="select" name="business_category" class="form-control" required="" fdprocessedid="39w0dg" required>
<option value="<?php echo $row['business_category'] ?>"><?php echo $row['business_category'] ?></option>
...
<option value="Toys">Toys</option>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3 pt-4">
                                       <label for="select" class=" form-control-label">Thames Color</label><br>
                                       <input type="color" name="thames_color" value="<?php echo $row['thames_color']?>" style="width:100%;">
                                    </div>  
                                    <!--<div class="col-12 col-md-3 pt-4">-->
                                    <!--   <label for="select" class=" form-control-label">Heading Color</label><br>-->
                                    <!--   <input type="color" name="text_color" style="width:100%;">-->
                                    <!--</div> -->
                                    <!--<div class="col-12 col-md-3 pt-4">-->
                                    <!--   <label for="select" class=" form-control-label">Footer Color</label><br>-->
                                    <!--   <input type="color" name="footer_color" style="width:100%;">-->
                                    <!--</div>    -->
                                </div>
