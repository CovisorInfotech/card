...
if (isset($_GET['type']) && $_GET['type'] !== '' && isset($_GET['id']) && $_GET['id'] > 0) {
  ...
  if ($type == 'conn' || $type == 'add') {
      ...
      mysqli_query($db, "update useradmin set connections_status='$connections_status' where id='$id'");
              ...
              <div id="profile" class="owl-carousel">
                ...
                <div class="item">
                  ...
                  <center><div style="border-radius: 50%!important;width: 80px!important;height: 80px!important;"><div style="background-image: url(admin/images/admin-img/<?php echo $row_profile['image'] ?>);background-position: center;background-repeat: repeat;background-size: cover;height: 80px;width: 80px;border-radius: 50%;border: 3px solid #ff3007;"></div></div></center>
                    ...
                    <?php
                      if ($row_profile['connections_status'] == '1') {
                      ?>
                      <a href="?id=<?php echo $row_profile['id'] ?>&type=conn" style="color: white;text-decoration: none;"><span style="font-size: 13px;"> Connection</span></a>
                      <?php
                      } else {
                      ?>
                      <a href="?id=<?php echo $row_profile['id'] ?>&type=add" style="color: white;text-decoration: none;"><span style="font-size: 13px;">Add</span></a>
                      <?php
                      }
                      ?>
...
<section class="mb-5">
    <div class="pt-4 pb-5">
        ...
        <div class="col-md-12"> 
          <div class="row">  
            <?php
    $sql_conne =  "SELECT  * from useradmin where connections_status='1'";
            ...
            <!-- <div class="col-md-4 d-none d-md-block d-lg-block">
                <div>
                   <div>
                    ...
                    <div class="pt-2 pb-2"><span><b>Suggestions for you</b></span></div>
                    </div>
                     <?php
                       $sql_conlist =  "SELECT  * from useradmin INNER JOIN connections on useradmin.id=connections.adminuser_id";
                       $res_conlist = mysqli_query($db, $sql_conlist);
                       while ($row_conlist = mysqli_fetch_assoc($res_conlist)) 
                       {
                     ?>
                    ...
                    <div class="d-flex">
                        <div class="pe-2">
                        <div><div style="background-image: url(admin/images/admin-img/<?php echo $row_conlist['image']?>);width: 70px;height: 70px;border-radius: 50%;border: 1px solid #ff0000;padding: 2px;background-position: center;background-size: cover;background-repeat: repeat;"></div></div>
                        </div>

                        <div>
                        <div>
                            <p class="mb-0"><b><?php echo $row_conlist['username'] ?></b></p>
                            <p><?php echo $row_conlist['business_category'] ?></p>
                        </div>
                        </div> 
                    </div>
                    </div>

                    <div class="col-md-3 col-lg-3 mt-auto mb-auto">
                        <div>
                        <button type="button" class="btn btn-primary btn-sm">Connection</button>
                        </div>
                    </div>
                    </div> 
                    <div class=""><hr></div> 
