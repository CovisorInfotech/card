                      ...
                      <div class="row">
                       ...
                       <div class="col-md-5 col-lg-5 m-auto pt-2">
                          <div class="col-md-12 col-lg-12">
                              <div class="row">
                                  <div class="col-6 col-md-6 col-lg-6 p-2 text-center"><a type="button" class="btn btn-warning w-100" style="color: white;font-weight: 600;background-color:<?php echo $row_adm['thames_color'] ?>!important;">Bookmark</a></div>
