...
<?php
 ...
 { 
  $name = $row_adm['username'];
  $email = $row_adm['email'];
  $photo = $row_adm['photo'];
  $mobile_no = $row_adm['mobile_number'];

  header('Content-Type: text/x-vcard');  
  header('Content-Disposition: inline; filename= "'.$phone.'.vcf"');  
...
<div class="container pt-2">
  <div class="row justify-content-center">
    ...
    <div class="col-md-4 col-lg-4 p-1"><div class="text-center btn-nr"><form action="" method="post" class="m-0"><button type="submit" name="file" style="background-color: #0f0f0f;color: white;border: none;"><span>Download</span></form></div></div>
    <div class="col-md-5 col-lg-5 p-1"><div class="text-center btn-nr"><form action="" method="post" class="m-0"><span><button type="submit" name="someAction" style="background-color: #0f0f0f;color: white;border: none;">Add Contact</button></span></form></div></div>
    </div>
    <div><hr></div>
    </div>
...
else
{
  ...
  <div class="container pt-2">
  <div class="row justify-content-center">
  <div class="col-md-7 col-lg-7 p-4 m-auto">
  <div class="alert alert-success alert-dismissible fade show" role="alert">
    <p class="text-center"><b>Pale Valid Card Number Enter</b></p>
  </div>
  </div>
  </div>
  ';
