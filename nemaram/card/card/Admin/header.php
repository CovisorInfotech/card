  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Card</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/photo/<?php echo $row_adm['photo'] ?>" alt="Profile" style="border: 2px solid #f59e0b;border-radius: 50%;" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $row_adm['username']?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $row_adm['username']?></h6>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <i class="bi bi-card-list"></i><span>Cards</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav" style="">
          ...
          <li>
            <a href="details.php" class="active">
          ...
          <li>
            <a href="theme.php" class="active">
              <i class="bi bi-circle"></i><span>Theme</span>
            </a>
          </li>
          <li>
            <a href="settings-card.php" class="active">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="NFC-card.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="leads.php">
          <i class="bi bi-chat-left-text"></i>
          <span>Leads</span>
        </a>
      </li><!-- End Dashboard Nav -->
        ...
        <ul id="tables-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav" style="">
          ...
          <li>
            <a href="subscription.php" class="active">
              <i class="bi bi-circle"></i><span>Subscription</span>
            </a>
          </li>
          <li>
            <a href="enterprise.php" class="active">
              <i class="bi bi-circle"></i><span>Enterprise</span>
            </a>
          </li>
          <li>
            <a href="help.php" class="active">
              <i class="bi bi-circle"></i><span>Help</span>
            </a>
          </li>
          <li>
            <a href="" class="active">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="rate-us.php">
